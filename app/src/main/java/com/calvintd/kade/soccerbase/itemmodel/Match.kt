...
class Match (
    ...
    // home
    var homeGoalDetails: List<String?>, var homeRedCardsCount: Int?, var homeRedCardDetails: List<String?>,
    ...
    // away
    var awayGoalDetails: List<String?>, var awayRedCardsCount: Int?, var awayRedCardDetails: List<String?>,
