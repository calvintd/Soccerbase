...
interface RetrofitService {
    ...
    suspend fun getMatchesByTeamName(@Query("e") teamName: String): Response<MatchResponse>

    @GET("/api/v1/json/1/searchteams.php")
    suspend fun getTeamsByName(@Query("t") teamName: String): Response<TeamResponse>
